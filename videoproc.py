...
def do_data(fname,  freq, maxcount, outfile=None, algo=None, get_chan = None, wavelet = None, start = 0):
    data, _ = get_frame_list(fname, freq=freq, max_count = maxcount, get_chan = get_chan, wavelet=wavelet, start=start)
    print(data.shape)
